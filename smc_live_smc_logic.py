"""
smc_live_smc_logic.py
Merged stable bot + simple SMC setup detection.
"""
...
# --------------------
# Simple SMC logic (Break of Structure)
# --------------------
def detect_smc(symbol, bars=50):
    """Detects a basic break of structure buy/sell setup"""
    ...
    # Buy: last close > previous swing high
    if last_close > prev_high:
        return "buy"
    # Sell: last close < previous swing low
